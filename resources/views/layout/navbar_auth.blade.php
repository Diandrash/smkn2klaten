<div class="navbar flex px-10 py-5 justify-between bg-amber-100 shadow-lg fixed top-0 left-0 right-0 z-30">
    <div class="logo-area">
    ...
    <div class="navlist flex list-none font-semibold text-xl self-center gap-16">
        ...
        <li class="text-black hover:text-amber-600"><a href="/logout">Logout</a></li>
    </div>
</div>